...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      ...
      {/* hero section */}
      <div className="flex flex-col items-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Watch on Samar TVs, PlayStation, Xbox, Chromecast, Apple TV, Blue-ray players, and more.
            </p>
          </div>
          {/* right */}
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1">
            <div className="relative">
              <img src="/stranger-things-lg.png" alt="stranger thins image" className="mt-4" />
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            <video
              className="absolute top-2 left-1/2 -translate-x-1/2 z-10 max-w-[63%] h-4/6"
              playsInline
              autoPlay={true}
              muted
            >
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          {/* left */}
          <div className="flex-1 relative">
            <img src="/kids.png" alt="kidz image" className="mt-4" />
          </div>
          {/* right */}
          <div className="flex-1 text-center md:text-left">
